...
export default function TVPage({
  ...
  const playEpisode = useCallback(
    (ep) => {
      ...
      const epPct = progress[epProgressKey] || 0;
      onPlay?.({
        item,
        mediaType: "tv",
        season: selectedSeason,
        ...
        setDubMode,
        m3u8Url,
        progressKey: epProgressKey,
        displayPct: epPct,
        progressLabel: epPct > 0 ? `${Math.round(epPct)}%` : "",
    ...
    [
      d, item, selectedSeason, onHistory, onPlay, progress,
      playerSource, setPlayerSource,
      resolvedPlayerUrl, resolvingUrl, resolveError,
      playerAccentColor, playerSubLang,
      dubMode, setDubMode, m3u8Url,
    ],
  );
